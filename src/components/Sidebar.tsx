...
// } from 'lucide-react';
// // Import your image
// import logoImage from './assets/image.png'; // Adjust the path if your assets folder is inside src
...
//   { id: 'dashboard', label: 'Dashboard', icon: BarChart3 },
//   { id: 'crowd', label: 'Crowd Analysis', icon: BarChart3 },
//   { id: 'missing', label: 'finding Person', icon: Search },
//   { id: 'offender', label: 'Offender Monitoring', icon: Shield },
//   { id: 'disabled', label: 'Disabled Assistance', icon: Accessibility },
//   { id: 'emergency', label: 'Emergency', icon: AlertTriangle },
//   { id: 'settings', label: 'Settings', icon: Settings },
...
//     <div className="fixed left-0 top-0 h-full w-64 bg-white shadow-lg z-40">
//       <div className="p-6 border-b border-gray-200">
//         {/* Replace text with the imported image */}
//         <img 
//           src={logoImage} 
//           alt="SHREE Management System" 
//           className="h-10 w-auto" // Adjust the height (h-10) to fit your design
//         />
//         <p className="text-sm text-gray-600 mt-1">Management System</p>
//       </div>
...
const menuItems = [
  { id: 'dashboard', label: 'Dashboard', icon: BarChart3 },
  { id: 'crowd', label: 'Crowd Analysis', icon: UserPlus2 },
  { id: 'missing', label: 'Finding Person', icon: Search },
  { id: 'offender', label: 'Offender Monitoring', icon: Shield },
  { id: 'disabled', label: 'Disabled Assistance', icon: Accessibility },
  { id: 'emergency', label: 'Emergency', icon: AlertTriangle },
