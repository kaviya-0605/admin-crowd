        ...
        {persons.map((person) => (
          ...
          >
            <div className="flex items-start space-x-4">
              <div className="w-16 h-16 bg-gray-300 rounded-lg flex-shrink-0 overflow-hidden">
                <img
                  src="/src/components/assets/person1.jpg"
                  alt={person.name}
                  className="w-full h-full object-cover"
                />
              </div>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h4 className="font-semibold text-gray-800">Dhamu</h4>
                    <p className="text-sm text-gray-600">Age: 20 years</p>
                  </div>
                  <div className="text-xs text-gray-500 flex items-center space-x-1">
                    <Clock className="w-3 h-3" />
                    <span>{person.timestamp}</span>
                ...
                <p className="text-sm text-gray-700 mb-3">Wearing White Shirt, Black pants, Specs, height of 5.8 feet</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                  <div className="flex items-center space-x-1 text-red-600">
                    <MapPin className="w-3 h-3" />
                    <span>Last seen: Main block</span>
                  </div>
                  <div className="flex items-center space-x-1 text-gray-600">
                    <Eye className="w-3 h-3" />
                    <span>{person.lastSeen}</span>
                  ...
                  <div className="flex items-center space-x-1 text-blue-600">
                    <Phone className="w-3 h-3" />
                    <span>Contact: +91 99988 76543</span>
                  </div>
                  <div className="text-gray-600">
                    Reported by: friend-kishore
                  </div>
                </div>
              </div>
            </div>
