...
export default function LiveCrowdDetection() {
  ...
  const [cameras] = useState<CameraFeed[]>([
    {
      ...
      detectedPersons: [
        { 
          ...
          confidence: 0.95, 
          type: 'person',
          imageUrl: 'https://res.cloudinary.com/dprwjya79/image/upload/v1759311768/WhatsApp_Image_2025-10-01_at_13.50.18_189551d3_toyulb.jpg',
          timestamp: '2024-01-15T10:30:00Z',
          boundingBox: { x: 120, y: 80, width: 40, height: 80 }
        },
        { 
          ...
          confidence: 0.88, 
          type: 'child',
          imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6TKRM4NnQwqRbSd1yjGckUiEBB0NH_AHIow&s',
          timestamp: '2024-01-15T10:30:01Z',
          boundingBox: { x: 200, y: 150, width: 35, height: 70 }
        },
        // Add more detected persons with image URLs...
    ...
    },
    {
      ...
      status: 'online',
      personCount: 156,
      liveFeedUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGQP13tddSPKGLDGizeH5EbZNIBxPgL10y7g&s',
      detectedPersons: [
        { 
          id: '6', 
          x: 150, 
    ...
    id: 'cam3',
    name: 'Parking Lot',
    location: 'North Side - Parking Area',
    status: 'offline',
    personCount: 0,
    liveFeedUrl: 'https://th-i.thgim.com/public/incoming/t8uw6t/article69026702.ece/alternates/FREE_1200/Tourist%20Vehicle%20parking1.jpg',
    detectedPersons: [],
    lastUpdate: '5 minutes ago',
    alertLevel: 'low',
  },
  {
    id: 'cam4',
    name: 'Dining Hall',
    location: 'South Block - Dining Area',
    status: 'online',
    personCount: 89,
    liveFeedUrl: 'https://akm-img-a-in.tosshub.com/indiatoday/images/photogallery/201611/8_112316011918_0.jpg?VersionId=W8i.v0A6ktkE2TOXaJLgPD6zv.g17Igd&size=686:*',
    detectedPersons: [
      { 
        id: '11', 
        x: 250, 
        ...
        confidence: 0.91, 
        type: 'person',
        imageUrl: 'https://res.cloudinary.com/dprwjya79/image/upload/v1759315649/WhatsApp_Image_2025-10-01_at_16.17.21_30244f10_dljomo.jpg',
        timestamp: '2024-01-15T10:31:12Z',
        boundingBox: { x: 250, y: 130, width: 45, height: 85 }
      },
      { 
        id: '12', 
        x: 300, 
        ...
        timestamp: '2024-01-15T10:31:14Z',
        boundingBox: { x: 300, y: 170, width: 40, height: 80 }
      }
    ],
    lastUpdate: '3 seconds ago',
    alertLevel: 'medium',
